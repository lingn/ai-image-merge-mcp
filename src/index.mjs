...
const tools = [
  {
    ...
    description:
      'Combine exactly two public JPG, PNG, or WebP image URLs into one AI-generated image. The call consumes credits from the configured AI Image Merge account and returns a task id for polling.',
    inputSchema: {
      type: 'object',
  ...
  },
  {
    ...
    description:
      'Check the status of an image merge task created by merge_images and return the generated image URL when it is ready.',
    inputSchema: {
      type: 'object',
      additionalProperties: false,
      properties: {
